...
@Component({
  selector: 'app-suspended-orders',
  templateUrl: './suspended-orders.component.html',
  styleUrls: ['./suspended-orders.component.scss']
})
export class SuspendedOrdersComponent implements OnInit {
  //
  // ─── START GENERAL DATA ──────────────────────────────────────────
  //
  invoideId;
